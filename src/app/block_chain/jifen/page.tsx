  ...
  const handleSubmit = (e: { preventDefault: () => void; }) => {
    ...
    return(
        ...
        <Row justify='center' gutter={[24, 10]}>
            ...
            <Col span={13}>
            <Typography>
                <Typography.Title style={{color:"color(srgb 0.35 0.4425 0.875)"}}>积分发放模块</Typography.Title>
            </Typography>
            </Col>
            <Col span={1}></Col>
        </Row>
        ...
        {/* <InputSearch loading searchButton='Search' placeholder='请输入交易ID' style={{ width: 350 }} />
