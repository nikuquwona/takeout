...
const table_data = [
  {
    key: '1',
    name: '1037135',
    salary: '0x6E5F9A23B5473D7C15E2ECC801BDAEBE76DD50B646F9B8CE84DC7A69D0E23543',
    address: 'bj-xxxxxxxxxx',
  }
];
function success() {
    Modal.success({
...
export default function Block_chain3() {
  ...
  const handleSubmit = (e: { preventDefault: () => void; }) => {
    ...
    return(
        ...
        <Menu mode='horizontal' theme='dark' defaultSelectedKeys={['4']}>
        ...
        <InputSearch loading searchButton='Search' placeholder='请输入用户ID/公钥' style={{ width: 350 }} />
